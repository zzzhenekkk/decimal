...
START_TEST(sub_2_test) {
  s21_decimal num1 = {{-1, -1, -1688, -2147483648}};
...
START_TEST(sub_3_test) {
  s21_decimal num1 = {{10, 11, 12, -2147483648}};
  s21_decimal num2 = {{11, 13, 15, -2147483648}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_4_test) {
  ...
  s21_decimal num2 = {{44, 369, 1687, -2147483648}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
...
START_TEST(sub_5_test) {
  s21_decimal num1 = {{45, 0, 10, -2147483648}};
  s21_decimal num2 = {{67, 0, 1, -2147352576}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ...
  ck_assert_int_eq(res.bits[3], -2147352576);
}
END_TEST
...
START_TEST(sub_8_test) {
  s21_decimal num1 = {{-3, -1, -1, -2147483648}};
  s21_decimal num2 = {{7, 0, 0, -2147418112}};
...
START_TEST(sub_10_test) {
  s21_decimal num1 = {{0, 0, 13, -2147483648}};
  s21_decimal num2 = {{4, 0, 0, -2146893824}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_11_test) {
  ...
  s21_decimal num2 = {{5, 4, 3, -2147483648}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_12_test) {
  ...
  s21_decimal num2 = {{5, 4, 8, -2147483648}};
  s21_decimal res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_13_test) {
  s21_decimal num1 = {{6, 7, 8, -2147483648}};
...
START_TEST(sub_14_test) {
  s21_decimal num1 = {{3, 1, 3, -2147483648}};
